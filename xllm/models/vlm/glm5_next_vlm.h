...
// Image preprocessing delegates to Python (Qwen2VLImageProcessor -> HF
// AutoImageProcessor); video preprocessing uses the GLM-family
// Glm4VVideoProcessor (frame sampling / resize / normalize / patchify ->
